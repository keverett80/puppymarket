...
import { faPaw, faCirclePlus, faHeartCircleCheck } from '@fortawesome/free-solid-svg-icons';

export default function LandingModal({ show, onHide }) {
  ...
  return (
    <Modal show={show} onHide={onHide} size="xl" centered backdrop="static" className="landing-modal">
        ...
        <div className="landing-wrapper">
          ...
          <section className="hero-section text-blue text-center d-flex align-items-center justify-content-center">
            <Container>
              ...
              <h1 className="display-5 fw-bold">Find a Home. Give a Home.</h1>
              <p className="lead">
                Every listing helps a pet find love — and gets shared across our social platforms to reach even more hearts. 🐾
              </p>

              <div className="d-flex justify-content-center gap-3 mt-4">
                <Button variant="primary" size="lg" onClick={() => { navigate('/view-pups'); onHide(); }}>
                  Browse Listings
                </Button>
                <Button variant="outline-light" size="lg" onClick={() => { navigate('/add-dog'); onHide(); }}>
                  Create a Listing
                </Button>
              </div>
            </Container>
          ...
          <footer className="text-center py-4 text-muted">
            ...
            <p>
              <a href="/about">About</a> | <a href="/contact-support">Contact</a> | <a href="/term-service">Terms</a> | <a href="/privacy-policy">Privacy</a>
            </p>
            <p className="mt-2">
              <a href="https://www.tiktok.com/@littlepawsplaces" target="_blank" rel="noopener noreferrer" className="me-3">
